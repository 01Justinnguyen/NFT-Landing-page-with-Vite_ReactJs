...
const OurCreaterCard = () => {
  return (
    <div className="relative bg-[url('/public/OurCreater/borderCard.png')] h-[96px] w-full object-cover bg-no-repeat cursor-pointer hover:scale-105 hover:transition-all">
